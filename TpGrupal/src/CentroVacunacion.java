...
public class CentroVacunacion {
	...
	public Map<String, Integer> reporteVacunasVencidas() { // listo -> O(1)
		return centroAlmacenamiento.getVacunasVencidas();
	}
	public Fecha getFechaDia() {
		return CentroAlmacenamiento.fecha;
	}
...
//
		// System.out.println(centro.turnosConFecha(new Fecha(27, 05, 2021))); //no
		// imprime nada aun
		// System.out.println(centro.turnosConFecha(new Fecha(28, 05, 2021)));
		// prueba para vacunas vencidas :

		centro.ingresarVacunas("Pfizer", 10, new Fecha(30, 05, 2021)); // no vencida
		centro.ingresarVacunas("Pfizer", 3, new Fecha(30, 9, 2021)); 

		centro.ingresarVacunas("Moderna", 10, new Fecha(30, 01, 2021));

		centro.ingresarVacunas("Sinopharm", 10, new Fecha(30, 01, 2021));
		System.out.println(centro.reporteVacunasVencidas());
		System.out.println(centro.vacunasDisponibles());
		// centro.ingresarVacunas("Moderna", 10, new Fecha(27, 07, 2021)); // Estan
		// vencidas, la fecha actual es 26/05/2021
