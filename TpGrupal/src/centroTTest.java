...
public class centroTTest {
	...
	public void setUp() throws Exception {
		...
		centro.ingresarVacunas("Sputnik", 10, new Fecha(30,05,2021)); // no vencida 10
		centro.ingresarVacunas("AstraZeneca", 10, new Fecha(20,03,2021)); // 10

		centro.inscribirPersona(34701000, new Fecha(1, 5, 1989), false, false); //4
		centro.inscribirPersona(29959000, new Fecha(20, 11, 1982), false, true);//1
		/*centro.inscribirPersona(35959564, new Fecha(20, 11, 1982), false, true);//1 borrar
		centro.inscribirPersona(36959125, new Fecha(20, 11, 1982), false, true);//1 borrar
		centro.inscribirPersona(33549125, new Fecha(20, 11, 1982), false, true);//1 borrar*/
    	centro.inscribirPersona(24780201, new Fecha(1, 6, 1972), true, false);//3
		centro.inscribirPersona(29223000, new Fecha(2, 5, 1982), false, true);//1
		centro.inscribirPersona(13000000, new Fecha(1, 5, 1958), true, false);//3
		centro.inscribirPersona(13000050, new Fecha(20, 6, 1958), false, true);//1
		centro.inscribirPersona(14000000, new Fecha(1, 1, 1961), false, false);//2
	...
	public void testIngresarVacunas() {
		...
		centro.ingresarVacunas("Pfizer", 10, new Fecha(30,9,2021)); // vencida
		centro.ingresarVacunas("Moderna", 10,new Fecha(30,5,2021)); // no vencida
		centro.ingresarVacunas("Moderna", 10,new Fecha(30,07,2021)); // vencida
		centro.ingresarVacunas("Sinopharm", 10,new Fecha(20,3,2021));
		
		assertEquals(40, centro.vacunasDisponibles());
		assertEquals(0, centro.vacunasDisponibles("Pfizer"));
		assertEquals(10, centro.vacunasDisponibles("Moderna"));
...
//		assertEquals(10, centro.vacunasDisponibles("Pfizer"));
		//assertEquals(20, centro.vacunasDisponibles());
...
//		
//		assertEquals(12, centro.vacunasDisponibles());
//		assertFalse(centro.listaDeEspera().contains(dniAVacunar)); //son los que no tienen turnos
...
//		assertTrue(centro.listaDeEspera().isEmpty());
	...
	public void testReporteVacunasVencidas() {
		...
		Fecha.setFechaHoy(22,2,2021); // se setea menos de un mes 
		/*	22/02/2021 - 20/03/2021 = 2 dias
		 *  22/02/2021 - 20/04/2021 = 61 dias -> 10 vencidas
		 */
	 //comento esta linea porque debe sacar vacunas al generar turnos 
		//solo pruebo que se eliminen las vacunas vencidas
